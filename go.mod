...
require (
	github.com/HuitianYu/telegraf-output-amqp_ext v0.0.0-20230120122748-15af4f7db2b7
...
retract (
    v0.0.0-20230120122748-15af4f7db2b7 // Falsely published
    v0.0.0-20230120123247-f6d4ef97802b // not mature
)