# AMQP_EXT Output Plugin

This plugin writes to a AMQP 0-9-1 Exchange, a prominent implementation of this
protocol being [RabbitMQ](https://www.rabbitmq.com/), which extends the existing
AMQP output plugin with heartbeat and connection_name.
...
[[outputs.amqp_ext]]
  ...
  ## Connection name. The default is "telegraf_producer".
  # connection_name = "telegraf_producer"

  ## Connection heartbeat.  If not provided, will default to 60s.  0s means no heartbeat
  # heartbeat = "60s"
